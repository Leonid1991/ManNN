...
changesOfImage = 3                                                              # how many changed copy we need 
source_path_old = 'Z:\VisualStudio\Python\Manchester_Working\TREND\images\old'  # where to save 
dataExtension(source_path_old,changesOfImage,img_shape)                         # proceed

changesOfImage = 2                                                               
source_path_young = 'Z:\VisualStudio\Python\Manchester_Working\TREND\images\young'
dataExtension(source_path_old,changesOfImage,img_shape)  
